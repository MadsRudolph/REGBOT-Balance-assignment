...
This appendix reproduces every figure from the note at full size for
readability. Each subsection matches the source figure in the body,
and the cross-references run both ways: the body figures point here,
and each appendix subsection notes which body figure it expands.
...
\label{app:task3-xy}
\textit{(referenced from §\ref{sec:velocity}; \href{https://youtu.be/yzdvBDtpQd8}{video of the Test~3b run})}

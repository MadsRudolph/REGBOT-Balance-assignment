...
\begin{figure}[H]
    ...
    \caption{Task~1: Hardware step (Test~0). Mission \texttt{bal=0, vel=0.3, log=15 : time=3}. Rise to $0.27\,\mathrm{m/s}$ in $0.012\,\mathrm{s}$.}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{images/regbot_task2_step.png}
    \caption{Task~2: Closed-loop step (Simulink) -- reference tracking.}
...
\begin{figure}[H]
    ...
    \caption{Test~3b XY trajectory at $0.8\,\mathrm{m/s}$ ($1\,\mathrm{m}$ sides, $0.2\,\mathrm{m}$ corner radius). Cumulative heading $359.8^{\circ}$ after four laps.}
...
\begin{figure}[H]
    ...
    \caption{Task~4: Open-loop $L_{\mathrm{pos}}$ Bode (Simulink). $\omega_c = 0.60\,\mathrm{rad/s}$, $\gamma_M \approx 57^{\circ}$ (after Lead drop), $GM = 25.17\,\mathrm{dB}$.}
